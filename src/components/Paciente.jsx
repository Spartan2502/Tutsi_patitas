...
const Paciente = ({ paciente, setPaciente, Eliminar }) => {
    ...
    const handleEliminar = () => {
        const respueta = confirm('Quieres eliminar ese paciente ??')
        if (respueta) Eliminar(id)
    }
